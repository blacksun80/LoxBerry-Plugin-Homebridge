...
echo "<INFO> Delete /etc/default/homebridge"
rm /etc/default/homebridge

echo "<INFO> Delete /etc/systemd/system/homebridge.service"
rm /etc/systemd/system/homebridge.service

# Homebridge Config UI deinstallieren
